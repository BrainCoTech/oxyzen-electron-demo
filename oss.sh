...
cloudFolder="universal/zenlite-sdk-prebuild/electron"
...
for os in "$@"; do
  if [ $os == 'mac' ]; then
    file_name="release/darwin/oxyzen-electron-1.0.0.dmg"
  elif [ $os == 'win' ]; then
    file_name="release/win32/oxyzen-electron-setup-1.0.0-x64.exe"
  fi
